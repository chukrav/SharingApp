...
public class EditContactActivity extends AppCompatActivity {
    ...
    public void saveContact(View view) {
        ...
        DeleteContactCommand deleteContactCommand = new DeleteContactCommand(contact_list,contact,
                context);
        deleteContactCommand.execute();
        AddContactCommand addContactCommand = new AddContactCommand(contact_list,
